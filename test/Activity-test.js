...
describe('Activity', () => {
  ...
  it('should be able to get stride length of a user by id', () => {
    expect(activity.getStrideLengthById(1)).to.be.an('number');
    expect(activity.getStrideLengthById(1)).to.be.equal(4.3);
  });

  it('should get the daily miles walked of a user', () => {
    expect(activity.getDailyMilesWalked("2022/01/20", 1)).to.be.a('string');
    expect(activity.getDailyMilesWalked("2022/01/20", 1)).to.equal('4.29');
  });

  it('should get the daily minutes active of a user', () => {
