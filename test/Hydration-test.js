...
describe('Hydration', () => {
  ...
  it('should be able to obtain ounces for most recent week', () => {
    ...
    expect(ounces1).to.deep.equal([
      "2019/06/15:31",
      "2019/06/16:68","2019/06/17:92","2019/06/18:45","2019/06/19:33","2019/06/20:89","2019/06/21:63"]);
    let ounces2 = hydration.obtainOuncesPerDayOverAWeek(waterData2);
    expect(ounces2).to.deep.equal(["2019/06/16:55","2019/06/17:67","2019/07/18:47","2019/08/19:21","2019/09/20:29","2019/10/21:14","2020/06/15:45"]);
  })
});
